...
import { createSupportAwareFetch } from '@/lib/support-feedback-compat-fetch';
...
export const supabase = createClient<Database>(
  ...
  SUPABASE_ANON_KEY || "placeholder-key",
  {
    ...
    global: {
      // Narrow compatibility bridge: only legacy feedback inserts are redirected
      // to the isolated Haqak support service. All other requests are untouched.
      fetch: createSupportAwareFetch(),
    },
  }
);
