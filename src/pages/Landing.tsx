          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <motion.span
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/[0.12] text-accent text-xs font-bold tracking-wider mb-8 border border-accent/20 shadow-sm shadow-accent/10"
              >
                <Scale className="w-3.5 h-3.5" />
                {t("hero.badge")}
              </motion.span>
              
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-foreground mb-8 tracking-tight leading-[1.1] font-serif">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
                <MagneticButton>
                  <Link to="/auth">
                    <Button size="lg" className="h-16 px-10 text-lg font-bold rounded-lg bg-accent text-accent-foreground hover:bg-accent/90 shadow-lg shadow-accent/30 gap-3 group transition-all duration-300 hover:shadow-xl">
                      {t("hero.cta_citizen")}
                ...
                <MagneticButton>
                  <Link to="/auth?type=mp">
                    <Button variant="outline" size="lg" className="h-16 px-10 text-lg font-bold rounded-lg border border-border/60 hover:border-accent/40 hover:bg-accent/5 gap-3 transition-all duration-300">
                      {t("hero.cta_mp")}
