...
const sections = [
  ...
  },
  {
    ...
    title: "حقوق المستخدم",
    content:
      "يحق للمستخدم طلب تعديل بياناته أو حذفها، كما يمكنه طلب إغلاق حسابه وفقًا لسياسات المنصة. وفي حال وجود استفسار بخصوص الخصوصية، يمكن التواصل مع فريق المشروع مباشرةً عبر البريد الرسمي: team@haqak.org",
  },
];
