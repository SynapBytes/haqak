# تصميم النظام المالي المتكامل لمشروع Haqak

## 1. مقدمة عامة

يهدف هذا المستند إلى تقديم تصميم شامل ومتكامل للنظام المالي لمشروع Haqak، مع التركيز على تعزيز الشفافية، الأمان، والمساءلة في إدارة أموال المساهمين. يستند هذا التصميم إلى تحويل نموذج العمل من الاعتماد على الجمعيات الأهلية إلى نموذج "القطاع الخاص الملتزم بالمسؤولية المجتمعية"، حيث تتولى شركة Haqak دور "المشغل التقني والمالي" بالتعاون مع بنك CIB.
...
تتكامل هذه المحاور مع نظام البلوكشين الحالي في Haqak لضمان سجل تدقيق غير قابل للتغيير، مما يعزز الثقة ويقلل من أي شبهات.

## 2. الهيكل القانوني والمالي (نموذج الـ Escrow التجاري)

بدلاً من الاعتماد على جمعيات أهلية، ستعمل شركة Haqak كـ "أمين استثمار" (Trustee) للمبالغ المجمعة. يتم فتح حساب فرعي مخصص (Sub-account) في بنك CIB لمشاريع Haqak (Escrow Account). يتم صياغة "شروط وأحكام" (Terms & Conditions) داخل التطبيق يوافق عليها المواطن قبل الدفع، تنص على أن الشركة هي "أمين استثمار" لهذه المبالغ لتنفيذ غرض محدد.
...
كل مليم يدخل الحساب يُسجل في Blockchain Ledger الخاص بـ Haqak. هذا يضمن عدم إمكانية تعديل سجلات الدفع، ويوفر "كشف حساب تقني" يطابق كشف حساب البنك، مما يرفع أي شبهة "غسيل أموال" أو "تربح غير مشروع" عن الشركة.
...
يهدف هذا الجزء إلى توضيح التصميم المقترح لنظام المقاول المعتمد (Verified Vendor System) ضمن مشروع Haqak. يهدف هذا النظام إلى ضمان الشفافية، الأمان، والمساءلة في عملية صرف الأموال للمنفذين الفعليين للمشاريع المجتمعية، وذلك لتجنب أي شبهات أو مخاطر تتعلق بسوء استخدام الأموال أو عدم إتمام المشاريع.
...
يستعرض هذا الجزء التصميم المقترح لآليتي الدفع على مراحل (Milestone Payments) والتصويت على الاسترداد (Refund Voting) ضمن مشروع Haqak. تهدف هاتان الآليتان إلى تعزيز الثقة، الشفافية، والمساءلة المالية، مما يضمن حماية أموال المساهمين وتحقيق أهداف المشاريع المجتمعية بكفاءة.
...
## 7. التكامل مع بوابات الدفع المحلية (Fawry & InstaPay)

لتعزيز الشمول المالي وتسهيل عملية الدفع على المواطنين، سيتم دمج منصة Haqak مع بوابات الدفع المحلية الرائدة في مصر: فوري (Fawry) وإنستاباي (InstaPay).

### 7.1. الربط مع فوري (Fawry Pay)

سيتيح هذا التكامل للمساهمين الدفع عبر شبكة فوري الواسعة، سواء نقداً من خلال الأكشاك أو إلكترونياً عبر بوابة Fawry Accept.

#### 7.1.1. آلية الدفع بالكود (Reference Number Payment)

*   **إنشاء كود مرجعي:** عند اختيار المواطن الدفع عبر فوري، يقوم نظام Haqak بتوليد كود مرجعي فريد للمساهمة والمشروع.
*   **الدفع النقدي:** يمكن للمواطن استخدام هذا الكود للدفع نقداً في أي من منافذ فوري المنتشرة في جميع أنحاء الجمهورية.
*   **التسوية اللحظية:** بمجرد إتمام عملية الدفع في منفذ فوري، يتم إرسال إشعار فوري (Webhook) إلى نظام Haqak، الذي يقوم بتسجيل المبلغ في حساب الـ Escrow المخصص للمشروع وفي سجل البلوكشين.

#### 7.1.2. بوابة Fawry Accept

*   **الدفع الإلكتروني:** سيتم دمج بوابة Fawry Accept مباشرة داخل تطبيق Haqak، مما يتيح للمساهمين الدفع باستخدام بطاقات ميزة (Meeza Cards) أو أي بطاقات بنكية أخرى مدعومة من فوري.
*   **تأكيد فوري:** يتم تأكيد عملية الدفع وتسجيلها في النظام والبلوكشين بشكل فوري.

### 7.2. الربط مع إنستاباي (InstaPay / IPN)

يعتبر إنستاباي حلاً مثالياً للتحويلات البنكية اللحظية، مما يوفر سرعة وكفاءة عالية في تحصيل المساهمات.

#### 7.2.1. التحويل المباشر لـ IPA (Instant Payment Address)

*   **عنوان دفع مخصص:** سيتم تخصيص عنوان دفع لحظي (IPA) خاص بحساب شركة Haqak في بنك CIB (مثلاً: `haqak@cib`).
*   **توليد QR Code:** يقوم تطبيق Haqak بتوليد رمز QR Code ديناميكي يحتوي على تفاصيل المساهمة (المبلغ، رقم المشروع). يمكن للمساهمين مسح هذا الرمز باستخدام تطبيق إنستاباي الخاص بهم لإتمام التحويل بسرعة وسهولة.
*   **إشعار التحويل الوارد:** سيتم استخدام تقنية "إشعار التحويل الوارد" (Inbound Transfer Notification) لربط التحويل البنكي الوارد بالمشروع والمساهم المعني آلياً، مما يضمن تسجيل الدفعة في الوقت الحقيقي في حساب الـ Escrow والبلوكشين.

### 7.3. مميزات التكامل مع بوابات الدفع المحلية

*   **الشمول المالي:** يخدم فوري شريحة واسعة من المواطنين الذين قد لا يمتلكون حسابات بنكية، بينما يوفر إنستاباي حلاً سريعاً وفعالاً لأصحاب الحسابات البنكية.
*   **سرعة التحصيل:** تضمن هذه التكاملات وصول الأموال إلى حساب الشركة في CIB بشكل فوري أو شبه فوري، مما يسرع من وتيرة بدء وتنفيذ المشاريع.
*   **التوثيق والشفافية:** كل عملية دفع عبر فوري أو إنستاباي سيتم توثيقها برقم مرجعي فريد وتسجيلها في سجل البلوكشين، مما يعزز الشفافية ويضمن عدم ضياع أي مليم.


## 8. هيكل الإعدادات المرنة (Flexible Configuration)

لضمان مرونة النظام وقابليته للتكيف مع التغييرات المستقبلية (مثل تغيير اسم المشروع، الدومين، أو تفاصيل الحساب البنكي)، سيتم تصميم هيكل إعدادات مرن يفصل هذه البيانات عن الكود البرمجي الأساسي.

### 8.1. ملف الإعدادات (Configuration File)

سيتم استخدام ملف إعدادات مركزي (مثلاً: `config.json` أو متغيرات بيئة `.env`) لتخزين المعلومات الحساسة والمتغيرة. هذا يتيح تحديث هذه البيانات بسهولة دون الحاجة لإعادة نشر التطبيق بالكامل.
...
```json
{
  ...
  "instapay_integration": {
    ...
    "webhook_secret": "[YOUR_INSTAPAY_WEBHOOK_SECRET]"
  },
  "technical_fee_percentage": 0.025, -- 2.5%
  "refund_vote_threshold": 0.51 -- 51%
}
```

### 8.2. متغيرات البيئة (Environment Variables)

للمعلومات الأكثر حساسية (مثل مفاتيح الـ API)، سيتم استخدام متغيرات البيئة (Environment Variables) لضمان أقصى درجات الأمان وعدم تضمينها مباشرة في ملفات الكود أو الإعدادات التي قد تكون مكشوفة.

## 9. دليل خطوات التفعيل المالي (Financial Activation Guide)
...
### 9.1. الإجراءات القانونية والتجارية

1.  **تأسيس الشركة رسمياً:** الحصول على السجل التجاري والبطاقة الضريبية.
2.  **فتح حساب بنكي للشركة في CIB:** يجب أن يكون حساباً تجارياً باسم الشركة.

### 9.2. تفعيل خدمات CIB

1.  **طلب خدمة CIB Corporate Gateway:** للتكامل المباشر مع بوابة الدفع.
2.  **فتح حساب Escrow فرعي:** مخصص لمشاريع Haqak لضمان فصل الأموال.
3.  **الحصول على IPA:** طلب عنوان دفع لحظي (Instant Payment Address) خاص بالشركة في CIB لتكامل InstaPay (مثلاً: `yourcompanyname@cib`).

### 9.3. تفعيل خدمات فوري (Fawry)

1.  **التعاقد مع فوري:** التواصل مع فوري للتعاقد على خدمات Fawry Pay و Fawry Accept.
2.  **الحصول على Merchant Code و Security Key:** هذه البيانات ضرورية لربط نظام Haqak ببوابة فوري.
3.  **تحديد Callback URL:** تزويد فوري بعنوان URL الخاص بنظام Haqak لتلقي إشعارات الدفع الفورية.

### 9.4. تفعيل خدمات إنستاباي (InstaPay)

1.  **التكامل مع البنك:** بما أن InstaPay يعمل من خلال البنوك، فإن تفعيله يعتمد بشكل كبير على تفعيل خدمات CIB المذكورة أعلاه.
2.  **الحصول على API Key و Webhook Secret:** قد يتطلب الأمر بعض التنسيق مع CIB أو البنك المركزي المصري للحصول على مفاتيح الـ API اللازمة لتتبع التحويلات الواردة عبر InstaPay آلياً.

### 9.5. تحديث إعدادات النظام

بعد الحصول على جميع البيانات المذكورة أعلاه، يتم تحديث ملف الإعدادات (`config.json` أو متغيرات البيئة) بالقيم الصحيحة، ويكون النظام جاهزاً للعمل.

## 10. الخلاصة النهائية

يمثل هذا التصميم المالي المتكامل لمشروع Haqak نموذجاً رائداً يجمع بين قوة البنية التحتية البنكية الرسمية (CIB)، سهولة وشمولية بوابات الدفع المحلية (Fawry و InstaPay)، وأمان وشفافية تقنية البلوكشين. من خلال نظام المقاول المعتمد، وآلية الدفع على مراحل، وخيار التصويت على الاسترداد، نضمن أقصى درجات الثقة والمساءلة، مما يمهد الطريق لنجاح باهر للمشاريع المجتمعية التي يدعمها Haqak.
