...
لتعزيز الشمول المالي وتسهيل عملية الدفع على المواطنين، سيتم دمج منصة Sutak مع بوابات الدفع المحلية الرائدة في مصر: فوري (Fawry) وإنستاباي (InstaPay).
...
*   **إنشاء كود مرجعي:** عند اختيار المواطن الدفع عبر فوري، يقوم نظام Sutak بتوليد كود مرجعي فريد للمساهمة والمشروع.
*   **الدفع النقدي:** يمكن للمواطن استخدام هذا الكود للدفع نقداً في أي من منافذ فوري المنتشرة في جميع أنحاء الجمهورية.
*   **التسوية اللحظية:** بمجرد إتمام عملية الدفع في منفذ فوري، يتم إرسال إشعار فوري (Webhook) إلى نظام Sutak، الذي يقوم بتسجيل المبلغ في حساب الـ Escrow المخصص للمشروع وفي سجل البلوكشين.

#### 7.1.2. بوابة Fawry Accept

*   **الدفع الإلكتروني:** سيتم دمج بوابة Fawry Accept مباشرة داخل تطبيق Sutak، مما يتيح للمساهمين الدفع باستخدام بطاقات ميزة (Meeza Cards) أو أي بطاقات بنكية أخرى مدعومة من فوري.
...
*   **عنوان دفع مخصص:** سيتم تخصيص عنوان دفع لحظي (IPA) خاص بحساب شركة Sutak في بنك CIB (مثلاً: `sutak@cib`).
*   **توليد QR Code:** يقوم تطبيق Sutak بتوليد رمز QR Code ديناميكي يحتوي على تفاصيل المساهمة (المبلغ، رقم المشروع). يمكن للمساهمين مسح هذا الرمز باستخدام تطبيق إنستاباي الخاص بهم لإتمام التحويل بسرعة وسهولة.
...
يهدف هذا الدليل إلى توضيح الخطوات العملية التي يجب اتخاذها لتفعيل النظام المالي المتكامل لمشروع Sutak بعد استكمال الإجراءات القانونية للشركة.
...
2.  **فتح حساب Escrow فرعي:** مخصص لمشاريع Sutak لضمان فصل الأموال.
...
2.  **الحصول على Merchant Code و Security Key:** هذه البيانات ضرورية لربط نظام Sutak ببوابة فوري.
3.  **تحديد Callback URL:** تزويد فوري بعنوان URL الخاص بنظام Sutak لتلقي إشعارات الدفع الفورية.
...
يمثل هذا التصميم المالي المتكامل لمشروع Sutak نموذجاً رائداً يجمع بين قوة البنية التحتية البنكية الرسمية (CIB)، سهولة وشمولية بوابات الدفع المحلية (Fawry و InstaPay)، وأمان وشفافية تقنية البلوكشين. من خلال نظام المقاول المعتمد، وآلية الدفع على مراحل، وخيار التصويت على الاسترداد، نضمن أقصى درجات الثقة والمساءلة، مما يمهد الطريق لنجاح باهر للمشاريع المجتمعية التي يدعمها Sutak.
