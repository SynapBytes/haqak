# آلية الدفع على مراحل (Milestone Payments) وآلية التصويت على الاسترداد (Refund Voting) لمشروع Haqak

## 1. المقدمة

يستعرض هذا المستند التصميم المقترح لآليتي الدفع على مراحل (Milestone Payments) والتصويت على الاسترداد (Refund Voting) ضمن مشروع Haqak. تهدف هاتان الآليتان إلى تعزيز الثقة، الشفافية، والمساءلة المالية، مما يضمن حماية أموال المساهمين وتحقيق أهداف المشاريع المجتمعية بكفاءة.
...
*   عند اكتمال مرحلة معينة، يقوم المقاول بتقديم طلب "إنجاز مرحلة" عبر منصة Haqak، مرفقاً به الأدلة (صور، فيديوهات، تقارير).
...
*   بعد الموافقة، يتم إصدار أمر صرف (Disbursement Order) آلياً من حساب Haqak Escrow إلى حساب المقاول المعتمد في CIB.
...
*   عند تفعيل الاسترداد، يقوم النظام آلياً ببدء عملية تحويل الأموال من حساب Haqak Escrow إلى الحسابات البنكية أو المحافظ الإلكترونية للمساهمين.
...
تعتبر آليتا الدفع على مراحل والتصويت على الاسترداد ركيزتين أساسيتين لتعزيز الثقة والأمان في منصة Haqak. من خلال هذه الآليات، نضمن أن أموال المساهمين تُدار بشفافية، وتُصرف بمسؤولية، وتُحمى في حال عدم اكتمال المشاريع، مما يعزز من مصداقية المنصة ويشجع على المشاركة المجتمعية الفعالة.
